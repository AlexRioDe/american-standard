...
<body id="americanStandard" class="americanStandard"><!--ADD CLASS startForm first click btn form-->
...
<!--  <script src="--><?php //bloginfo('stylesheet_directory'); ?><!--/p1-test/picturefill.js" async></script>-->
